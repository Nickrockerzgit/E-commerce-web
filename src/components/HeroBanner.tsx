  ...
  return (
    <div className="max-w-7xl mx-auto px-3 md:px-4 py-4">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
        ...
        {/* ===== CAROUSEL ===== */}
        <div className="lg:col-span-9 relative overflow-hidden rounded-lg 
        ...
        {/* ===== RIGHT APP BANNER ===== */}
        <div className="lg:col-span-3 bg-gradient-to-b from-orange-400 to-pink-500 
                        rounded-xl p-3 text-white flex flex-col justify-between">

          {/* Top */}
          <div>
            <div className="flex items-center gap-2 mb-2">
              <img src={darazLogo} alt="Daraz" className="w-7 h-7" />
              <span className="font-bold text-base md:text-lg">TRY DARAZ APP</span>
            </div>

            <div className="inline-flex items-center bg-orange-500 px-3 py-1 rounded-full text-xs md:text-sm font-semibold mb-3">
              ⭐ 4.8 Rated
            </div>

            <div className="bg-white/20 rounded-xl p-2 space-y-2">
              <div className="flex items-center gap-3">
                <div className="bg-white text-orange-500 rounded-lg p-2 text-sm">🚚</div>
                <span className="text-xs md:text-sm font-semibold">Free Shipping</span>
              </div>

              <div className="flex items-center gap-3">
                <div className="bg-white text-pink-500 rounded-lg p-2 text-sm">🎟️</div>
                <span className="text-xs md:text-sm font-semibold">Exclusive Vouchers</span>
              </div>
            </div>
          </div>
          ...
          <div className="mt-3">
            <div className="flex items-center gap-2 bg-white rounded-xl p-2">
              <img src={qrCode} alt="QR" className="w-16 h-16 md:w-20 md:h-20" />
              <img src={appStore} alt="Store" className="w-[100px] md:w-[120px] object-contain" />
            </div>

    ...
    <div className="min-h-screen bg-gray-50 pb-10">
      ...
      <header className="bg-gradient-to-r from-orange-500 to-orange-600 text-white sticky top-0 z-50 shadow-md">
        <div className="max-w-7xl mx-auto px-4 py-3.5 sm:py-4">
          <div className="flex items-center gap-3">
            <button
              onClick={handleBack}
              className="p-2 hover:bg-orange-600 rounded-full transition -ml-2"
            >
              <ArrowLeft size={24} />
            </button>
      ...
      <main className="max-w-7xl mx-auto px-4 py-6 sm:py-8">
        <div className="flex flex-col lg:flex-row lg:gap-8">
          {/* Left - Address Form (takes full width on mobile) */}
          <div className="lg:flex-1 order-2 lg:order-1">
            <div className="bg-white rounded-xl shadow-md p-5 sm:p-6 md:p-7">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  />
                  {errors.customerName && (
                    <p className="mt-1.5 text-sm text-red-500">{errors.customerName}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.customerPhone && (
                    <p className="mt-1.5 text-sm text-red-500">{errors.customerPhone}</p>
                  )}
                </div>
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-orange-500 to-orange-600 text-white py-4 rounded-xl font-semibold text-lg hover:from-orange-600 hover:to-orange-700 transition shadow-md mt-6 active:scale-[0.98]"
                >
                  Proceed to Payment
                </button>
              </form>
          ...
          {/* Right - Order Summary (sticky on desktop, normal flow on mobile) */}
          <div className="lg:w-96 order-1 lg:order-2 mb-8 lg:mb-0">
            <div className="bg-white rounded-xl shadow-md p-5 sm:p-6 sticky top-20 lg:top-24">
              <h2 className="text-xl font-bold text-gray-900 mb-5">Order Summary</h2>

              <div className="flex gap-4 mb-6 pb-5 border-b border-gray-200">
                <img
                  src={product.image}
                  alt={product.title}
              ...
              <div className="mt-6 p-4 bg-green-50 rounded-lg text-center sm:text-left">
                <p className="text-sm text-green-800 font-medium">
                  Free Delivery on this order!
                </p>
              </div>
